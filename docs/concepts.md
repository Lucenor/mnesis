...
- The **most recent 2 user turns** are always protected, regardless of token position.
...
Optionally, an LLM-based summary can be generated by configuring `FileConfig.exploration_summary_model`.
