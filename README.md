...
> Mnesis is the reference TypeScript implementation of the LCM architecture. mnesis is the Python port. Raw Opus 4.6 uses no context management — scores collapse past 32K tokens.
